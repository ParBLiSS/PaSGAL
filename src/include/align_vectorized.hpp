...
//use this macro to decide whether each thread uses
//local copy of graph (1 means yes, 0 mean no)
#define CREATE_LOCAL_COPY 1
                    ...
                    for (size_t l = 0; l < this->blockHeight; l++)
                    {
                      ...
                      if (l == 0)
                      {
                        for(size_t m = graph.offsets_in[k]; m < graph.offsets_in[k+1]; m++)
                        {
                          ...
                          if (k - graph.adjcny_in[m] < this->blockWidth)
                    ...
                    for (size_t l = 0; l < this->blockHeight; l++)
                    {
                      ...
                      if (l == 0)
                      {
                        for(size_t m = graph.offsets_out[k]; m < graph.offsets_out[k+1]; m++)
                        {
                          ...
                          if (graph.adjcny_out[m] - k < this->blockWidth)
